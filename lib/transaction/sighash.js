...
var BufferUtil = btgLib.util.buffer;
...
var sighashForForkId = function(transaction, sighashType, inputNumber, subscript, satoshisBN) {
  ...
  $.checkArgument(
    ...
    'For ForkId=79 signatures, satoshis or complete input must be provided'
  );

  function GetForkId() {
    return 79; // In the UAHF, a fork id of 0 is used (see [4] REQ-6-2 NOTE 4)
  };
